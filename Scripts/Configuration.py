...
class Configs:
    ...
    num_classes      = pd.read_csv(r'/content/drive/MyDrive/Datasets/Drones Images/data/Label Images/class_dict.csv')['name'].nunique() - 1 #subtruct the "unlabeled" class #main_folder + 'Data/class_dict.csv'
